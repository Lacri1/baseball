...
public class GameLogicUtil {
    ...
    public static String determinePitchResultByStats(Pitcher pitcher, Batter batter) {
        ...
        // 1. 스트라이크 확률 계산
        double pitcherStrikeoutRate = pitcher.getStrikeOut() / pitcherTotalBatters;
        ...
        // 2. 볼 확률 계산
        double pitcherWalkRate = (pitcher.getBaseOnBalls() + pitcher.getHitByPitch()) / pitcherTotalBatters;
    ...
    public static String determineHitResultWithTiming(boolean swing, Pitcher pitcher, String pitchType, Object timing,
        ...
        double pitcherKRate = Math.max(0.0, Math.min(1.0, (double) pitcher.getStrikeOut() / pitcherBF));
        ...
        double batterBA = batter.getBattingAverage();
